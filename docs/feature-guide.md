...
| Finite burns and mass continuity | `mode="finite_thrust"` | Mission Patterns | `examples/composable/relative/19_relative_finite_burn_coast.py` |
| RIC/fixed/Euler thrust direction | `ThrustControl` | Thrust Direction And Attitude | `examples/composable/earth_centered/19_thrust_frames_and_attitude.py` |
| CWH and exact relative motion | `Dynamics.cwh`, `Dynamics.relative` | Concepts | `examples/composable/relative/16_exact_ric_formulations.py` |
| D'Amico/classical ROE targeting | relative-element constraints | Mission Patterns | `examples/composable/relative/17_damico_free_time_target.py` |
| Three-burn relative topology | composable relative phases | Mission Patterns | `examples/composable/relative/20_relative_three_burn_transfer.py` |
| Coordinate and representation conversion | `octavian.relative` transforms | Concepts | `examples/composable/relative/13_relative_representations.py` |
...
| Cannonball drag and SRP | `Cannonball`, `Perturbations` | Cannonball Drag And SRP | `examples/composable/relative/23_cannonball_drag_srp.py` |
